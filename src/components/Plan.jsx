...
{/* Right Side */}
    ...
    <p className='text-2xl py-6' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, eaque.</p>
    <p className='pb-6' >Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolor nemo, consequuntur fuga vero esse distinctio voluptatibus, quam eligendi impedit tempore expedita deserunt, doloribus praesentium doloremque corporis voluptate dolorum voluptatem sint.</p>
    <div>
        <button className='border-black mr-4 hover:shadow-xl' >Learn More</button>
        <button className='bg-black text text-white border-black hover:shadow-xl ' >Book Your Trip</button>
    </div>
    </div>
    </div>
  )
